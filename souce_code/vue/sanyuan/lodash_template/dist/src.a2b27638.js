...
},{"buffer":"node_modules/buffer/index.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
var MyComponent = function MyComponent(props) {
  var compiler = MyComponent.cache || (MyComponent.cache = (0, _lodash.template)('<h1><%= title %></h1>')); //缓存模板

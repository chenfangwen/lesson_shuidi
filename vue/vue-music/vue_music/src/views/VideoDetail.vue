<template>
    <div class="videoDetial">
        <div class="header">
            ...
            <div class="name">{{videoInfo.title}}</div>
        </div>
...
export default {
    ...
    mounted(){
        ...
        console.log(id)
        mv.getVideoDetail(id).then(res => {
            if(res.data.data){
                console.log(res.data)
                this.videoInfo = res.data.data
                this.duration = res.data.data.durationms/1000
            }
        })
        mv.getVideoUrl(id).then(res => {
            console.log(res.data.urls[0].url, 'url')
            if(res.data){
